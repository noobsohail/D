...
from MarinKitagawa import OWNER_ID
from MarinKitagawa.confing import get_str_key
from MarinKitagawa.events import register
from MarinKitagawa.services.telethon import tbot as update
...
if not UPSTREAM_REPO_URL:
    UPSTREAM_REPO_URL = "https://github.com/noobsohail/ErzaScarletX"
...
async def upstream(ups):
    ...
    if conf == "deploy":
        ...
        await lol.edit("`Successfully Updated! \nRestarting......`")
        args = [sys.executable, "-m", "MarinKitagawa"]
