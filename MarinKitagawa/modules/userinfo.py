...
from MarinKitagawa.__main__ import STATS, TOKEN, USER_INFO
from MarinKitagawa.modules.sql import SESSION
import MarinKitagawa.modules.sql.userinfo_sql as sql
from MarinKitagawa.modules.disable import DisableAbleCommandHandler
from MarinKitagawa.modules.sql.global_bans_sql import is_user_gbanned
from MarinKitagawa.modules.sql.afk_sql import is_afk, set_afk
from MarinKitagawa.modules.sql.users_sql import get_user_num_chats
from MarinKitagawa.modules.helper_funcs.chat_status import sudo_plus
from MarinKitagawa.modules.helper_funcs.extraction import extract_user
from MarinKitagawa import telethn
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Support", url="https://t.me/HenilDiscussupport"),
                            InlineKeyboardButton(
                                "Creator", url="https://t.me/Tachiken")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "❂ <b>Stats For <a href='https://t.me/ErzaScarlet_groupbot'>MarinKitagawa</a>:</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
