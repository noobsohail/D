...
import MarinKitagawa.modules.sql.welcome_sql as sql
...
from MarinKitagawa.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from MarinKitagawa.modules.helper_funcs.misc import build_keyboard, revert_buttons
from MarinKitagawa.modules.helper_funcs.msg_types import get_welcome_type
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id in DEV_USERS:
                update.effective_message.reply_text(
                    "See you later at the IndiAnime Bot Support!",
                    reply_to_message_id=reply,
                )
                return
